...
//        QMember m = new QMember("m"); // 별칭 직접 지정하여 Q클래스 인스턴스를 사용하는 방법
//        import static com.study.querydsl.entity.QMember.member; // static import 활용하여 Q클래스 인스턴스 사용
    ...
    public void search() {
        Member findMember = queryFactory
                ...
                .where(member.username.eq("member1")
                        .and(member.age.eq(10))) // 이름이 member1 and 나이가 10인 사람을 조회해
                .fetchOne();
    ...
    public void searchAndParam() {
        Member findMember = queryFactory
                ...
                .where(
                        ...
                        member.age.eq(10)
                ) // 이름이 member1 and 나이가 10인 사람을 조회해
                .fetchOne();
    ...
    public void aggregation() {
        List<Tuple> result = queryFactory // 데이터 타입이 여러개일 때 Tuple
                .select(
                        member.count(),
                        member.age.sum(),
                        member.age.avg(),
